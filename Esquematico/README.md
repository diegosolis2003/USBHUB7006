...
## Archivos incluidos
* **`TAREA1.pdf`** (o equivalente): Documento PDF en alta resolución que compila todas las páginas del diagrama esquemático. Está exportado de manera que se mantiene la nitidez de los símbolos, etiquetas de red (*net names*) y texto técnico para una navegación cómoda.
